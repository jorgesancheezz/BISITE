...
def plot_kurtosis_forced(data, forced_xlim=(0.0, 10.0), fraction=1.0, seed=42):
    rng = np.random.RandomState(seed)
    metric = 'orig_kurtosis'
    rhythms = ['AF', 'NSR']
    ...
    for i, ritmo in enumerate(rhythms):
        ...
        ax_hist.set_xlabel('Orig Kurtosis')
    ...
    outfile = RESULTS_DIR / f'normality_orig_kurtosis_forced_{int(fraction*100)}.png'
...
def main():
    ...
    out = plot_kurtosis_forced(data, forced_xlim=(0.0, 50.0), fraction=args.fraction, seed=args.seed)
    print('Saved', out)
