...
def main():
    ...
    if 'lung_cancer' in df_prep.columns:
        ...
        plt.title('Matriz de Confusión (Evaluación)', fontsize=14, fontweight='bold', pad=20)
        plt.tight_layout()
        plt.savefig(unique_out_name('confusion_matrix_eval'), dpi=300, bbox_inches='tight')
        plt.close()
